...
- [x] `T-0401` Add `/v1/sessions` and `/v1/sessions/:id/samples` read endpoints
  - status: DONE
  - owner: @opencode
  - deps: `T-0304`
...
- [x] `T-0402` New UI: show most recent session chart with cooling tail + markers
  - status: DONE
  - owner: @opencode
  - deps: `T-0401`, `T-0203`
...
- [x] `T-0602` New UI: session list + detail page + notes editing
  - status: DONE
  - owner: @opencode
  - deps: `T-0601`
